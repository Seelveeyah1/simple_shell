 ...
 * Return: 1 if chain is a delimeter, else 0
 */
...
/**
 * check_chain - to check if we should continue chaining
...
/**
 * replace_alias - replacing all aliases in the tokenized string
 * @info: the parameter structure
...
/**
 * replace_vars - replacing the variables in the tokenized string
 * @info: the parameter structure
 * Return: 1 if replaced, else 0
 */
