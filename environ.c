...
/**
 * _getenv - to get the value of an environment variable
 * @info: Structure containing potential arguments used to maintain constant function prototype.
...
/**
 * _mysetenv - to set up a new environment variable, or modify an existing one
 * @info: Structure containing potential arguments used to maintain constant function prototype.
 * Return: Must be 0
 */
 ...
 * @info: Structure containing potential argumentsused to maintain constant function prototype.
 * Return: Must be 0
 */
